...
`movements->quantity_type` | The type in which the quantity is expressed. Amongst others currency and funds quantities are expressed as `AMOUNT`. Equity and other sorts of securities as `SHARES`. | `Enum("SHARES", "AMOUNT")` | SHARES | yes
